    ...
    <div class="blogMostRead__posts">
        ...
        ?>
                    <a class="blogMostRead__post" href="<?= get_the_permalink() ?>">
                        <div class="blogMostRead__postImg"><?php wp_get_attachment_image(the_post_thumbnail(), 'medium'); ?></div>
                        <div class="blogMostRead__postTitle ">
                            <div class="blogMostRead__date date"><?php the_date('d.m.y'); ?></div>
                            <h4><?php the_title(); ?></h4>
                        </div>
                    </a>
...
<?php if ($query->have_posts()) : $cpt = 0; ?>
    <section class="blogPosts wrapper">
            ...
            <a class="blogPosts__post" href="<?php the_permalink(); ?>">
                ...
                <div class="blogPosts__info">
                    <div class="blogPosts__postTitleDate">
                        <h4><?php the_title(); ?></h4>
                        <div class="blogPosts__date date"><?php the_date('d.m.y'); ?></div>
                    </div>
                    <div class="blogPosts__excerpt"><?php the_excerpt(); ?></div>
                </div>
