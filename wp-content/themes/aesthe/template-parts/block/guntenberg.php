...
<?php
if (is_admin()) : echo "<div style=\"width: 100%; padding: 20px 20px;text-align: center;font-size: 10px;background: #eee\">Image, titre & texte (cliquer pour modifier)</div>";
else : ?>
