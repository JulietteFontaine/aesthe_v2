 ...
 * 
 */
if (is_admin()) : echo "<div style=\"width: 100%; padding: 20px 20px;text-align: center;font-size: 10px;background: #eee\">Cartes tarifs (cliquer pour modifier)</div>";
else :
...
?>
    <h3 class="tarifsCards__title title-capitalize"><?php the_field('title') ?></h3>
            ...
            ?>
                <article class="tarifsCard">
                    ...
                    <div class="tarifsCard__offers">
                        ...
                        ?>
                            <a target="_blank" class="cta" href="<?php echo $card['lien_epil']["url"]; ?>">
